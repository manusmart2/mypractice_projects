package seleniumweddriver_extentreportv4;
...
//we need two dependent jars 1is extentreports 4.0.1 and 2nd is commons-io 2.6
public class SeleniumExtenrReportv4example {
	...
	public void noCommecrceTitleTest() {
		test = extent.createTest("noCommecrceTitleTest");
